    ...
    render(){
        return(
            <View style = {styles.container}>
                    ...
                    <Text style ={styles.headertext}>      Sign in to never lose </Text>
                    ...
                    <View style = {styles.link}>
                        ...
                        <View >
                            <Text style = {styles.footer}>I already have an account.<Link to="/Login">Login</Link></Text>
                        </View>
                    </View>
            </View>
